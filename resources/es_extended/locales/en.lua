Locales['es'] = {
  ...
  ['dar_a'] = 'dar a',
  ['cantidad'] = 'cantidad',
  ['darmunicion'] = 'dar municion',
  ['cantidaddemunicion'] = 'cantidad de municion',
  ['sinmunicion'] = 'no tienes suficiente municion!',
  ['dar_articulo'] = 'tu diste ~y~%sx~s~ ~b~%s~s~ a ~y~%s~s~',
  ['recibir_articulo'] = 'tu recibiste ~y~%sx~s~ ~b~%s~s~ de ~b~%s~s~',
  ['dar_arma'] = 'tu diste ~y~1x~s~ ~b~%s~s~ a ~y~%s~s~.',
  ['dar_municion_de_arma'] = 'dar ~y~1x~s~ ~b~%s~s~ con ~o~%sx~s~ ballas a ~y~%s~s~.',
