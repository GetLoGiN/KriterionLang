Locales['es'] = {
  ...
  ['player_clothes'] = 'Ropa',
  ['remove_cloth'] = 'remover ropa',
  ['removed_cloth'] = 'el auendo se a quitado del guardarropa!',
  ...
  ['not_enough_in_property'] = 'no hay suficiente ~r~de ese objeto~s~ en la pripiedad!',
  ['player_cannot_hold'] = 'tu ~r~no~s~ tienes suficiente ~y~espacio libre space~s~ en tu inventario!',
}
