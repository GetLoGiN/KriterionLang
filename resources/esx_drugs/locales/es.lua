Locales ['es'] = {
  -- weed
  ['weed_pickupprompt'] = 'presiona ~INPUT_CONTEXT~ para recolectar ~g~Marijuana húmeda~s~.',
  ['weed_inventoryfull'] = 'no puedes llevar más ~g~Marijuana húmeda~s~!',
  ['weed_processprompt'] = 'presiona ~INPUT_CONTEXT~ para ~g~secar la Marijuana~s~.',
  ...
  -- drug dealer
  ['dealer_prompt'] = 'presiona ~INPUT_CONTEXT~ para hablar con el ~r~Camello~s~.',
